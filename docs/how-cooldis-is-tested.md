# How Cooldis Is Tested

Cooldis is a runtime for governing autonomous agents, and most of its code is
...
Three parties develop Cooldis, and the process is built on their separation:
