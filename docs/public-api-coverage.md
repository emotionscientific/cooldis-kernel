...
| Daemon config | [Cooldis Daemon](daemon.md), [Cooldis IO](io.md) | `cooldis daemon config validate --help` | partial | Placement defaults, Telegram, and `clock.tick` route config are documented; add versioned config schema reference. |
