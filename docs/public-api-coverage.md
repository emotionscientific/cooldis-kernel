...
| Agent manifests | [Agent Manifest Ontology](agent-manifest-ontology.md), [Cooldis Agent CLI](agent-cli.md), [V1 Release Candidate Gate](v1-release-candidate.md) | `cooldis agent * --help` | partial | The typed workspace requirement and bind-plane host mount are documented; a generated schema reference remains follow-up work. |
