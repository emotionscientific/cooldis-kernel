...
pub(super) async fn tool_manual(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn run_tool(mut args: Vec<OsString>) -> CooldisResult<()> {
    if args.is_empty()
        || args
            .first()
...
pub(super) async fn tool_build(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn tool_list(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn tool_publish(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn build_tool_package(package_path: &Path) -> CooldisResult<BuiltToolPackage> {
...
pub(super) fn reject_user_kernel_tool_package(package: &ToolPackageSource) -> CooldisResult<()> {
...
pub(super) fn package_fixture_vfs(package: &ToolPackageSource) -> CooldisResult<Arc<CooldisVfs>> {
...
pub(super) fn size_limit(label: &str, value: u64) -> CooldisResult<usize> {
...
pub(super) fn reject_package_build_overrides(options: &BuildArgs) -> CooldisResult<()> {
...
pub(super) fn reject_package_publish_overrides(options: &PublishArgs) -> CooldisResult<()> {
    if options.name.is_some()
        || options.module_path.is_some()
...
pub(super) async fn tool_run(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn tool_source(mut args: Vec<OsString>) -> CooldisResult<()> {
    if args.is_empty()
        || args
            .first()
            .is_some_and(|arg| arg == "--help" || arg == "-h")
...
pub(super) async fn tool_source_add(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn tool_source_discover(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn tool_source_list(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn tool_source_show(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn tool_source_remove(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) fn parse_build_args(args: Vec<OsString>) -> CooldisResult<BuildArgs> {
    let mut name = None;
...
pub(super) fn parse_publish_args(args: Vec<OsString>) -> CooldisResult<PublishArgs> {
    let mut name = None;
    let mut module_path = None;
...
pub(super) fn parse_tool_registry_args(
    args: Vec<OsString>,
    command: &str,
) -> CooldisResult<ToolRegistryArgs> {
    let mut registry_root = None;
    let mut help = false;
    let mut iter = args.into_iter();
    while let Some(arg) = iter.next() {
...
pub(super) fn parse_run_args(args: Vec<OsString>) -> CooldisResult<RunArgs> {
    let mut module_path = None;
    let mut bin_path = None;
    let mut config_path = None;
...
pub(super) fn parse_tool_manual_args(args: Vec<OsString>) -> CooldisResult<ToolManualArgs> {
    let mut registry_root = None;
    let mut json = false;
    let mut help = false;
    let mut positionals = Vec::new();
...
pub(super) fn parse_tool_source_add_args(args: Vec<OsString>) -> CooldisResult<ToolSourceAddArgs> {
    let mut name = None;
    let mut kind = None;
    let mut url = None;
...
pub(super) fn parse_tool_source_show_args(
    args: Vec<OsString>,
) -> CooldisResult<ToolSourceShowArgs> {
    let mut name = None;
    let mut state_home = None;
    let mut json = false;
    let mut help = false;
...
pub(super) fn parse_mount_arg(value: &str) -> CooldisResult<MountArg> {
...
pub(super) fn parse_header_arg(value: &str) -> CooldisResult<(String, String)> {
...
pub(super) fn parse_u64_arg(flag: &str, value: &str) -> CooldisResult<u64> {
    value
        .parse()
        .map_err(|_| usage_error(format!("{flag} must be a positive integer")))
}

pub(super) fn parse_metadata_arg(value: &str) -> CooldisResult<(String, Value)> {
...
pub(super) fn load_tool_config(path: Option<&Path>) -> CooldisResult<ToolConfigFile> {
    let discovered;
...
pub(super) fn resolve_cargo_manifest_path(module_path: &Path) -> CooldisResult<PathBuf> {
...
pub(super) async fn load_vfs(mounts: Vec<MountArg>) -> CooldisResult<Arc<CooldisVfs>> {
    let vfs = Arc::new(CooldisVfs::new(Arc::new(InMemoryFs::new())));
    for mount in mounts {
        let fs = Arc::new(
