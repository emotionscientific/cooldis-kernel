...
pub(super) async fn run_auth(mut args: Vec<OsString>) -> CooldisResult<()> {
    if args.is_empty()
        || args
            .first()
...
pub(super) async fn auth_status(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn auth_set(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn auth_delete(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) fn parse_auth_set_args(args: Vec<OsString>) -> CooldisResult<AuthSetArgs> {
