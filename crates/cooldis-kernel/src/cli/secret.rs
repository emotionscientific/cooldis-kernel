...
pub(super) async fn run_secret(mut args: Vec<OsString>) -> CooldisResult<()> {
    if args.is_empty()
        || args
            .first()
...
pub(super) async fn secret_import(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn secret_set(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn secret_list(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn secret_status(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn secret_delete(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) fn parse_secret_import_args(args: Vec<OsString>) -> CooldisResult<SecretImportArgs> {
    let mut name = None;
...
pub(super) fn parse_secret_set_args(args: Vec<OsString>) -> CooldisResult<SecretSetArgs> {
    let mut name = None;
...
pub(super) fn default_user_state_home() -> CooldisResult<PathBuf> {
...
pub(super) async fn open_secret_store(
    state_home: Option<PathBuf>,
) -> CooldisResult<SqliteSecretStore> {
...
pub(super) fn cross_process_database_guidance(alternative: &str) -> CooldisError {
    usage_error(format!(
...
pub(super) fn secret_cli_error(err: impl std::fmt::Display) -> CooldisError {
    CooldisError::RuntimeFactory(format!("secret store failed: {err}"))
}

pub(super) fn provider_cli_error(err: impl std::fmt::Display) -> CooldisError {
