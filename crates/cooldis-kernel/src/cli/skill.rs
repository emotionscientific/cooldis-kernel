...
pub(super) async fn run_skill(mut args: Vec<OsString>) -> CooldisResult<()> {
    if args.is_empty()
        || args
            .first()
...
pub(super) async fn skill_publish(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) async fn skill_import(args: Vec<OsString>) -> CooldisResult<()> {
...
pub(super) fn parse_skill_publish_args(args: Vec<OsString>) -> CooldisResult<SkillPublishArgs> {
...
pub(super) fn parse_skill_import_args(args: Vec<OsString>) -> CooldisResult<SkillImportArgs> {
