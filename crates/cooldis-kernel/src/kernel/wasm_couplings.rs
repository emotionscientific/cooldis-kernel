use crate::{
    CooldisError, CooldisResult, CouplingDischarge, CouplingExecutionResult, CouplingExecutor,
    CouplingInvocation, EventKind, EventRecord, LocalOperationRegistry,
};
...
fn decode_discharge(coupling_id: &str, bytes: &[u8]) -> CooldisResult<CouplingExecutionResult> {
