...
pub const CRASH_CUT_REGISTRY: &[CrashCutRegistration] = &[
    CrashCutRegistration {
        ...
        seam_path: "daemon_io::CooldisDaemonIoBridge::pause_after_ingress_claim",
    },
    CrashCutRegistration {
    ...
    CrashCutRegistration {
        ...
        seam_path: "daemon_io::CooldisDaemonIoBridge::ingress_binding_barrier",
    },
    CrashCutRegistration {
        name: "thread-load-root",
        seam: CrashCutSeam::ThreadLoadRootBarrier,
        seam_path: "daemon_io::CooldisDaemonIoBridge::thread_load_root_barrier",
    },
    CrashCutRegistration {
        name: "spawn-snapshot",
