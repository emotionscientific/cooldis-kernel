...
pub(crate) use verlet as kernel_test;
...
use verlet::{
    ...
    AgentRuntimeFactory, AgentToolRouter, CanonicalMessage, HookHandler, HookHandlerOutput,
    HookHandlerSpec, HookPipeline, HookRequest, InMemorySessionStore, OperationRegistry,
    RuntimeEventKind, RuntimeServices, ThreadCommand, ThreadContext, ThreadEvent, ThreadStatus,
    ToolDefinition, ToolPermissionDecision, ToolPermissionGate, ToolPermissionRequest,
    VerletResult, emit_runtime_event,
};
