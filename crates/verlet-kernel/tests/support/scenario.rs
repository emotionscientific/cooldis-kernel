...
use super::kernel_test::{
    ...
    AppServerListenAddr, EventKind, EventProvenance, EventRecord, EventRecordId, EventSequence,
    EventStore, EventStreamId, HistoryResult, LocalOfflineProviderClient, NewEventRecord,
    NewObservationRecord, ObservationRecord, ObservationStore, ProviderApi,
    ...
    SessionStore, StreamCursorV1, ThreadBaseRef, ThreadCommand, ThreadCoordinates, ThreadEvent,
    ThreadId, ThreadStatus, TurnSubmissionMode, VerletAppServer, VerletAppServerConfig,
    VerletDaemonIoBridge, VerletDaemonQueueWorker, VerletEgressRetryConfig, VerletIoRouteConfig,
};
...
use verlet_io_pgqrs::sqlite_dsn;
...
fn scenario_route() -> VerletIoRouteConfig {
    VerletIoRouteConfig {
...
pub async fn run_stream_io_crash_scenario(seed: u64) -> Result<StreamIoCrashReceipt, String> {
    use verlet_history_sqlite::SqliteSessionStore;
    use verlet_sqlite::{Db, DbConfig, io::IO};
